    ...
    <Section>
      ...
      >
        <div className="space-y-4 text-center xl:space-y-6">
          <h2 className="text-2xl font-semibold lg:text-2xl lg:font-bold xl:text-3xl font-gagalin">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-9">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`relative flex flex-col gap-3 rounded-lg border-2 p-4 xl:gap-4 xl:p-6 ${plan.id === 2
                ? "border-primary max-sm:-order-1"
                : "border-secondary"
                }`}
            >
              <div
                className={`absolute left-1/2 top-4 -z-10 aspect-square w-2/3 -translate-x-1/2 max-lg:blur-[100px] lg:blur-[200px] ${plan.id === 2 ? "bg-primaryVar4" : "bg-secondaryVar3"
                  }`}
              />
              <div className="space-y-2 text-center xl:space-y-3">
                <p
                  className={`text-sm lg:text-base ${plan.id === 2 ? "text-primary" : "text-secondary"
                    }`}
                >
                  Package
                </p>
              ...
              <div className="space-y-2 xl:space-y-3">
                <p
                  className={`text-center text-sm lg:text-base ${plan.id === 2 ? "text-primary" : "text-secondary"
                    }`}
                >
                  Description
                </p>
