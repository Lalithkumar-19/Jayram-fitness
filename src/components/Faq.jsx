  ...
  return (
    <Section>
      ...
      >
        ...
        <h2 className="text-center text-xl font-semibold lg:text-2xl lg:font-bold xl:text-3xl font-gagalin">
          FAQ
        </h2>
            ...
            <div key={q.id}>
              <div
                ...
                className={`-mb-px -ml-px -mr-0.5 -mt-0.5 border-2 px-3 py-2 md:px-4 md:py-3 xl:px-6 xl:py-4 ${openQuestion === i ? "border-primary" : "border-secondary"
                  } flex cursor-pointer items-center justify-between rounded-lg hover:bg-white/5 transition-colors`}
              >
                <h3 className="text-sm font-medium md:text-base xl:text-xl xl:font-semibold font-gagalin">
                  {q.question}
                </h3>
