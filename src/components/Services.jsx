...
const Services = () => {
  const GYM_INFO = {
    ...
    social: {
      instagram: "https://instagram.com/jayaramfitness",
      facebook: "https://facebook.com/jayaramfitness",
      youtube: "https://youtube.com/jayaramfitness",
    },
  };
  ...
  return (
    <Section className="relative">
      ...
      >
        <h2 className="text-xl font-semibold lg:text-2xl lg:font-bold xl:text-3xl font-gagalin">
            ...
            <div key={i} className="relative">
              ...
              <button className="absolute bottom-6 left-6 flex items-center gap-1">
                ...
                <a
                  ...
                  className="md:font-regular relative text-lg font-medium md:text-xs xl:text-sm">
                  Learn More
                </a>
