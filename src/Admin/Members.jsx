...
import { Plus, Search, Filter, MoreVertical, Edit2, Trash2, Eye, ChevronLeft, ChevronRight, X } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 className="text-3xl font-bold font-gagalin">Members Management</h1>
                    <p className="text-gray-400">Manage gym members and subscriptions</p>
                </div>
                <button
                    onClick={() => setShowAdmissionForm(true)}
                    className="flex items-center gap-2 bg-primary px-6 py-3 rounded-xl font-bold text-white shadow-lg shadow-primary/20 hover:bg-primaryVar1 transition-all"
                >
